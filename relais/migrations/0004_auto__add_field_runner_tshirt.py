...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Runner.tshirt'
        db.add_column(u'relais_runner', 'tshirt',
                      self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Runner.tshirt'
        db.delete_column(u'relais_runner', 'tshirt')
    ...
    models = {
        ...
        u'relais.payment': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "u'jZEVIGNTcU5H'", 'max_length': '30'})
        },
        u'relais.price': {

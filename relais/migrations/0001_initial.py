...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'relais_setting', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('email_contact', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('url_home', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('phone', self.gf('django.db.models.fields.CharField')(max_length=14)),
            ('first_event', self.gf('django.db.models.fields.DateTimeField')()),
            ('event', self.gf('django.db.models.fields.DateTimeField')()),
            ('closure_postal', self.gf('django.db.models.fields.DateTimeField')()),
            ('closure_online', self.gf('django.db.models.fields.DateTimeField')()),
            ('rule', self.gf('django.db.models.fields.TextField')()),
            ('disclamer', self.gf('django.db.models.fields.TextField')()),
            ('postal_address', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'relais', ['Setting'])

        # Adding model 'Price'
        db.create_table(u'relais_price', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('config', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('who', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('when', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('price', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'relais', ['Price'])

        # Adding unique constraint on 'Price', fields ['config', 'who', 'when']
        db.create_unique(u'relais_price', ['config', 'who', 'when'])

        # Adding model 'Federation'
        db.create_table(u'relais_federation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal(u'relais', ['Federation'])

        # Adding model 'Company'
        db.create_table(u'relais_company', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal(u'relais', ['Company'])

        # Adding model 'Club'
        db.create_table(u'relais_club', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal(u'relais', ['Club'])

        # Adding model 'School'
        db.create_table(u'relais_school', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal(u'relais', ['School'])

        # Adding model 'Payment'
        db.create_table(u'relais_payment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('price', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['relais.Price'])),
            ('method', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('state', self.gf('django.db.models.fields.BooleanField')()),
            ('token', self.gf('django.db.models.fields.CharField')(default=u'actHbZ5JVEC8', max_length=30)),
            ('time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('ipn', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ipn.PayPalIPN'], null=True, blank=True)),
        ))
        db.send_create_signal(u'relais', ['Payment'])

        # Adding model 'Runner'
        db.create_table(u'relais_runner', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('first_name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('last_name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('gender', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('birthday', self.gf('django.db.models.fields.DateField')()),
            ('license_nb', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('school', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['relais.School'], null=True, blank=True)),
            ('federation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['relais.Federation'], null=True, blank=True)),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['relais.Company'], null=True, blank=True)),
            ('club', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['relais.Club'], null=True, blank=True)),
            ('certificat', self.gf('django.db.models.fields.BooleanField')()),
            ('legal_status', self.gf('django.db.models.fields.BooleanField')()),
            ('num', self.gf('django.db.models.fields.PositiveIntegerField')(unique=True)),
        ...
        db.send_create_signal(u'relais', ['Runner'])

        # Adding unique constraint on 'Runner', fields ['first_name', 'last_name', 'birthday', 'gender']
        db.create_unique(u'relais_runner', ['first_name', 'last_name', 'birthday', 'gender'])

        # Adding model 'Individual'
        db.create_table(u'relais_individual', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('runner', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['relais.Runner'], unique=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('category', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('payment', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['relais.Payment'], unique=True)),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['relais.Company'], null=True, blank=True)),
        ))
        db.send_create_signal(u'relais', ['Individual'])

        # Adding model 'Team'
        db.create_table(u'relais_team', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('category', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('runner_1', self.gf('django.db.models.fields.related.OneToOneField')(related_name='team_runner_1', unique=True, to=orm['relais.Runner'])),
            ('runner_2', self.gf('django.db.models.fields.related.OneToOneField')(related_name='team_runner_2', unique=True, to=orm['relais.Runner'])),
            ('runner_3', self.gf('django.db.models.fields.related.OneToOneField')(related_name='team_runner_3', unique=True, to=orm['relais.Runner'])),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['relais.Company'], null=True, blank=True)),
            ('payment', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['relais.Payment'], unique=True)),
        ))
        db.send_create_signal(u'relais', ['Team'])


    def backwards(self, orm):
        # Removing unique constraint on 'Runner', fields ['first_name', 'last_name', 'birthday', 'gender']
        db.delete_unique(u'relais_runner', ['first_name', 'last_name', 'birthday', 'gender'])

        # Removing unique constraint on 'Price', fields ['config', 'who', 'when']
        db.delete_unique(u'relais_price', ['config', 'who', 'when'])

        # Deleting model 'Setting'
        db.delete_table(u'relais_setting')

        # Deleting model 'Price'
        db.delete_table(u'relais_price')

        # Deleting model 'Federation'
        db.delete_table(u'relais_federation')

        # Deleting model 'Company'
        db.delete_table(u'relais_company')

        # Deleting model 'Club'
        db.delete_table(u'relais_club')

        # Deleting model 'School'
        db.delete_table(u'relais_school')

        # Deleting model 'Payment'
        db.delete_table(u'relais_payment')

        # Deleting model 'Runner'
        db.delete_table(u'relais_runner')

        # Deleting model 'Individual'
        db.delete_table(u'relais_individual')

        # Deleting model 'Team'
        db.delete_table(u'relais_team')
    ...
    models = {
        u'ipn.paypalipn': {
            ...
            'receiver_email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'blank': 'True'}),
        ...
        u'relais.individual': {
            ...
            'company': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['relais.Company']", 'null': 'True', 'blank': 'True'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'payment': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['relais.Payment']", 'unique': 'True'}),
            'runner': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['relais.Runner']", 'unique': 'True'})
        },
        u'relais.payment': {
            ...
            'price': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['relais.Price']"}),
            'state': ('django.db.models.fields.BooleanField', [], {}),
            'time': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "u'actHbZ5JVEC8'", 'max_length': '30'})
        },
        u'relais.price': {
            'Meta': {'unique_together': "(('config', 'who', 'when'),)", 'object_name': 'Price'},
            'config': ('django.db.models.fields.CharField', [], {'max_length': '5'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'price': ('django.db.models.fields.IntegerField', [], {}),
            'when': ('django.db.models.fields.CharField', [], {'max_length': '5'}),
            'who': ('django.db.models.fields.CharField', [], {'max_length': '5'})
        },
        u'relais.runner': {
            'Meta': {'unique_together': "(('first_name', 'last_name', 'birthday', 'gender'),)", 'object_name': 'Runner'},
            'birthday': ('django.db.models.fields.DateField', [], {}),
            'certificat': ('django.db.models.fields.BooleanField', [], {}),
            'club': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['relais.Club']", 'null': 'True', 'blank': 'True'}),
            'company': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['relais.Company']", 'null': 'True', 'blank': 'True'}),
            'federation': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['relais.Federation']", 'null': 'True', 'blank': 'True'}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'gender': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_name': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'legal_status': ('django.db.models.fields.BooleanField', [], {}),
            'license_nb': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
            'num': ('django.db.models.fields.PositiveIntegerField', [], {'unique': 'True'}),
            'ready': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'school': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['relais.School']", 'null': 'True', 'blank': 'True'}),
        ...
        u'relais.setting': {
            ...
            'closure_online': ('django.db.models.fields.DateTimeField', [], {}),
            'closure_postal': ('django.db.models.fields.DateTimeField', [], {}),
            'disclamer': ('django.db.models.fields.TextField', [], {}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75'}),
            'email_contact': ('django.db.models.fields.EmailField', [], {'max_length': '75'}),
            'event': ('django.db.models.fields.DateTimeField', [], {}),
            'first_event': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'phone': ('django.db.models.fields.CharField', [], {'max_length': '14'}),
            'postal_address': ('django.db.models.fields.TextField', [], {}),
            'rule': ('django.db.models.fields.TextField', [], {}),
            'url': ('django.db.models.fields.URLField', [], {'max_length': '200'}),
            'url_home': ('django.db.models.fields.URLField', [], {'max_length': '200'})
        },
        u'relais.team': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'payment': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['relais.Payment']", 'unique': 'True'}),
            'runner_1': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'team_runner_1'", 'unique': 'True', 'to': u"orm['relais.Runner']"}),
            'runner_2': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'team_runner_2'", 'unique': 'True', 'to': u"orm['relais.Runner']"}),
            'runner_3': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'team_runner_3'", 'unique': 'True', 'to': u"orm['relais.Runner']"})
        }
    }

    complete_apps = ['relais']
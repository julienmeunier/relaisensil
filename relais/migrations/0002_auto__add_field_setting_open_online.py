...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Setting.open_online'
        db.add_column(u'relais_setting', 'open_online',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2016, 1, 7, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Setting.open_online'
        db.delete_column(u'relais_setting', 'open_online')
    ...
    models = {
        ...
        u'relais.payment': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "u'uCM3nrgDLpkA'", 'max_length': '30'})
        },
        u'relais.price': {

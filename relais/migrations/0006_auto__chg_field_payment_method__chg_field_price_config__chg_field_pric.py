...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Payment.method'
        db.alter_column(u'relais_payment', 'method', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Price.config'
        db.alter_column(u'relais_price', 'config', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Price.who'
        db.alter_column(u'relais_price', 'who', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Price.when'
        db.alter_column(u'relais_price', 'when', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Team.category'
        db.alter_column(u'relais_team', 'category', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Individual.category'
        db.alter_column(u'relais_individual', 'category', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'Payment.method'
        db.alter_column(u'relais_payment', 'method', self.gf('django.db.models.fields.CharField')(max_length=3))

        # Changing field 'Price.config'
        db.alter_column(u'relais_price', 'config', self.gf('django.db.models.fields.CharField')(max_length=5))

        # Changing field 'Price.who'
        db.alter_column(u'relais_price', 'who', self.gf('django.db.models.fields.CharField')(max_length=5))

        # Changing field 'Price.when'
        db.alter_column(u'relais_price', 'when', self.gf('django.db.models.fields.CharField')(max_length=5))

        # Changing field 'Team.category'
        db.alter_column(u'relais_team', 'category', self.gf('django.db.models.fields.CharField')(max_length=3))

        # Changing field 'Individual.category'
        db.alter_column(u'relais_individual', 'category', self.gf('django.db.models.fields.CharField')(max_length=3))
    ...
    models = {
        ...
        u'relais.payment': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "u'qxi2mt42N1y7'", 'max_length': '30'})
        },
        u'relais.price': {
            'Meta': {'unique_together': "(('config', 'who', 'when'),)", 'object_name': 'Price'},
            'config': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'price': ('django.db.models.fields.IntegerField', [], {}),
            'when': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'who': ('django.db.models.fields.CharField', [], {'max_length': '10'})
        },
        u'relais.runner': {
            'Meta': {'unique_together': "(('first_name', 'last_name', 'birthday', 'gender'),)", 'object_name': 'Runner'},
            'birthday': ('django.db.models.fields.DateField', [], {}),
            'canicross': ('django.db.models.fields.BooleanField', [], {}),
            ...
            'tshirt': ('django.db.models.fields.CharField', [], {'max_length': '4', 'null': 'True', 'blank': 'True'})
        },
        u'relais.school': {
        ...
        u'relais.setting': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'open_online': ('django.db.models.fields.DateTimeField', [], {}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Runner.canicross'
        db.add_column(u'relais_runner', 'canicross',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Runner.canicross'
        db.delete_column(u'relais_runner', 'canicross')
    ...
    models = {
        ...
        u'relais.payment': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "u'6RDQL0Fsn6wU'", 'max_length': '30'})
        },
        u'relais.price': {
